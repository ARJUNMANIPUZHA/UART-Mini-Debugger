...
/* Checking whether a particular status flag is set or not*/
...
/* Enable interrupt for USART2 in NVIC */
...
/* This ISR is triggered when a USART2 interrupt occurs */
...
/* It is called from the USART ISR to notify about specific events */
